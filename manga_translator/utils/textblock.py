...
class TextBlock(object):
    ...
    def __init__(self, lines: List[Tuple[int, int, int, int]],
        ...
        self.translation_raw = kwargs.get('translation_raw') or translation
        self.layout_mode = kwargs.get('layout_mode', 'default')
        ...
        self.adjust_bg_color = kwargs.get('adjust_bg_color', True)
